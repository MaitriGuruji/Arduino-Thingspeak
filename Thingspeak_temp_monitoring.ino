...
int echoPin = 10;
int led = 7;
String AP = "RAJ";       // CHANGE ME
String PASS = "123456789"; // CHANGE ME
String API = "QS2ZV0C9ZD9L9LYA";   // CHANGE ME
//CJ9ZQZLHJZ391OY6
//QS2ZV0C9ZD9L9LYA
...
void loop() {
   ...
   else if(distance>10)
 {
   ...
   //float temp =(output*500)/1023;
//    sendVal = temp;
    String getData = "GET /update?api_key="+ API +"&"+ field +"="+String(analogRead(AOT));
    //String getData = "GET /update?api_key="+ API +"&"+ field +"="+String(temp);
